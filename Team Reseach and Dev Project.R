...
rio_csv <- import("C:/Users/ele/Documents/Github/Team-Research-and-Dev-Project/Data Science Salary 2021 to 2023.csv")
head(rio_csv)
plot(rio_csv$work_year)
hist(rio_csv$work_year)
...
ggplot(rio_csv, aes(x = salary_in_usd, fill = experience_level)) +
  geom_histogram(binwidth = 4000, color = "PURPLE", alpha = 0.7) +
